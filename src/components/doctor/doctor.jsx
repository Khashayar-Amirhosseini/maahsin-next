...
import { addDoctors, removeDoctor } from "@/redux/action/doctorAction";
...
const Doctrors = (props) => {
   ...
   useEffect(()=>{
    if(doctorInfo.image===null){
        doctorInfo.image=imageProfile.src;
    }
},[])
    const handleAdd=()=>{
